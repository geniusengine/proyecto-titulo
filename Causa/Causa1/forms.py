...
class DemandaForm(forms.ModelForm):
    ...
    ARANCELES_CHOICES = [
        ...
        ('Manuel_Aguirre_Abogados_BNCO_ESTADO_NOT_MARTILLERO', '25000'),
    ...
    nombTribunal = forms.ChoiceField(choices=[
        ...
        ('3° Juzgado de Letras La Serena', '3° Juzgado de Letras La Serena'),
        ('1° Juzgado de Letras Coquimbo', '1° Juzgado de Letras Coquimbo'),
        ('2° Juzgado de Letras Coquimbo', '2° Juzgado de Letras Coquimbo'),
        ('3° Juzgado de Letras Coquimbo', '3° Juzgado de Letras Coquimbo'),
        ('Juzgado de Letras del Trabajo de La Serena', 'Juzgado de Letras del Trabajo de La Serena'),
        ('Juzgado de Garantía La Serena', 'Juzgado de Garantía La Serena'),
        ('Juzgado de Juicio Oral en lo Penal La Serena', 'Juzgado de Juicio Oral en lo Penal La Serena'),
        ('Juzgado de Familia La Serena', 'Juzgado de Familia La Serena'),
        ('Juzgado de Familia Coquimbo', 'Juzgado de Familia Coquimbo'),
        ('Corte de Apelaciones de La Serena', 'Corte de Apelaciones de La Serena'),
    ])
    actu = forms.ChoiceField(choices=[
         ('Búsqueda Negativa', 'Búsqueda Negativa'),
        ('Búsqueda Positiva', 'Búsqueda Positiva'),
        ('Not. por cédula', 'Not. por cédula'),
        ('Not. Art. 44', 'Not. Art. 44'),
        ('Req. de pago en Oficina', 'Req. de pago en Oficina'),
        ('Op. al Embargo', 'Op. al Embargo'),
        ('Not. Personal', 'Not. Personal'),
        ('Not. Personal/Req. de Pago', 'Not. Personal/Req. de Pago'),
        ('Not. art. 52', 'Not. art. 52'),
        ('Embargo con Fuerza Pública', 'Embargo con Fuerza Pública'),
        ('Embargo Frustrado', 'Embargo Frustrado'),
        ('Embargo Banco', 'Embargo Banco'),
        ('Embargo Vehículo', 'Embargo Vehículo'),
        ('Embargo TGR', 'Embargo TGR'),
        ('Op.Retiro', 'Op.Retiro'),
        ('Retiro de Vehículo', 'Retiro de Vehículo'),
        ('In.Vehiculo', 'In.Vehiculo'),
        ('Not. Martillero', 'Not. Martillero'),
        ('Retiro Frustrado', 'Retiro Frustrado'),
        ('Retiro de Especies', 'Retiro de Especies'),
        ('Retiro fuerza pública', 'Retiro fuerza pública'),
        ('Otro', 'Otro'),
    ])
